  ...
  return (
    <main>
      <PageIntro
        ...
        body="This archive is meant to feel closer to a festival poster than a normal portfolio grid — one edition per year, like a festival that keeps getting bigger. Start with the name, then move into that artist's filmed history and the projects attached to it."
      />

      <section className="px-4 pb-16 sm:px-6 sm:pb-20">
        <div className="mx-auto max-w-[100rem]">
          <LineupEditions editions={editions} />
        </div>
      </section>
